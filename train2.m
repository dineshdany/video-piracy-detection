close all;
clc;
myFile=dir('E:\IIIT WORKS\Matlb\BTP2\videos\*.MP4'); 
mNIQE=[];
mBRISQUE=[];
mPIQE=[];
Predict_value=[];
...
myFile1=dir('E:\IIIT WORKS\Matlb\BTP2\videos\Screen_captured\*.MP4');
s1=[];
...
for m1 = 1 : 61
     ...
     s1=loudness1;
     thisVideo1 = VideoReader(thisfilename);
     a1=thisVideo1;
     i1=33;
while hasFrame(a1)
    if( i1==100)
...
display(Audio_Quality);



T=table(mNIQE,mBRISQUE,mPIQE,Audio_Quality,Predict_value);
writetable(T,'E:\IIIT WORKS\Matlb\BTP2\train2.csv');
type('E:\IIIT WORKS\Matlb\BTP2\train2.csv');
